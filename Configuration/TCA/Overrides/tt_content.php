...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes(
    'tt_content',
    '--div--;Configuration,aisearch_url_hash,aisearch_api_host,aisearch_prompt_template,aisearch_list_all_sources',
    'list',
    'after:subheader'
);
...
$GLOBALS['TCA']['tt_content']['types']['list']['previewRenderer']['rmsaisearch_search']
    = \Rms\RmsAiSearch\Preview\SearchPreviewRenderer::class;
